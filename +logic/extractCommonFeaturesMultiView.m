function [matchedPoints1, matchedPoints2, currPoints, currFeatures, indexPairs] = extractCommonFeaturesMultiView(image_1, prevFeatures, prevPoints, camera_params, varargin)
